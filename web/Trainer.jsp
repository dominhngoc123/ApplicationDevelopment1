<%-- 
    Document   : Trainer
    Created on : May 15, 2020, 12:57:52 PM
    Author     : Ngoc Do Minh
--%>
            ...
            <tbody>
                <s:iterator value="listCourse">
                    <tr>
                        ...
                        <td><s:property value="courseStartDate"/></td>
                        <td><s:property value="courseEndDate"/></td>
                        <td colspan="2"><s:property value="courseLocation"/></td>                        
                        <td><a class="btn btn-info btn-block" href="trainerLoadDetailCourse?courseID=<s:property value="courseID"/>">Detail</a></td>
                    </tr>
                </s:iterator>                
            </tbody>
        </table>
